...
class Factor(QWidget):
    def __init__(self, parent=None):
        ...
        filter_condition_gird_box.addWidget(self.filter_ito_group, 1, 0)
        filter_condition_gird_box.addWidget(self.filter_artr_group, 1, 1)
        filter_condition_gird_box.addWidget(self.filter_dar_group, 1, 2)
        filter_condition_gird_box.addWidget(self.filter_ltv_group, 2, 0)
        filter_condition_gird_box.addWidget(self.filter_op_group, 2, 1)
        filter_condition_gird_box.addWidget(self.filter_last_turn_over_group,
                                            2, 2)
        filter_condition_gird_box.addWidget(
            self.filter_last_percent_change_group, 3, 0)
        ...
        self.sort_pe_input.setPlaceholderText('权重默认1')
        ...
        self.sort_roe_input.setPlaceholderText('权重默认1')
        ...
        self.sort_cmv_input.setPlaceholderText('权重默认1')
        ...
        self.sort_ito_input.setPlaceholderText('权重默认1')
        ...
        self.sort_artr_input.setPlaceholderText('权重默认1')
        ...
        self.sort_dar_input.setPlaceholderText('权重默认1')
        ...
        self.sort_ltv_input.setPlaceholderText('权重默认1')
        ...
        self.sort_op_input.setPlaceholderText('权重默认1')
        ...
        self.sort_last_turn_over_input.setPlaceholderText('权重默认1')
        ...
        self.sort_last_percent_change_input.setPlaceholderText('权重默认1')
        ...
        sort_condition_gird_box.addWidget(self.sort_ito_group, 1, 0)
        sort_condition_gird_box.addWidget(self.sort_artr_group, 1, 1)
        sort_condition_gird_box.addWidget(self.sort_dar_group, 1, 2)
        sort_condition_gird_box.addWidget(self.sort_ltv_group, 2, 0)
        sort_condition_gird_box.addWidget(self.sort_op_group, 2, 1)
        sort_condition_gird_box.addWidget(self.sort_last_turn_over_group, 2, 2)
        ...
        self.score_input.setPlaceholderText('大于排名卖出')
        ...
        self.max_hold_days_input.setPlaceholderText('超过就卖出')
        ...
        self.max_drawdown_input.setPlaceholderText('达到就卖出')
        ...
        self.min_hold_days_input.setPlaceholderText('不足天数不卖')
        ...
        backtest_condition_gird_box.addWidget(self.score_group, 1, 0)
        backtest_condition_gird_box.addWidget(self.max_hold_days_group, 1, 1)
        backtest_condition_gird_box.addWidget(self.take_profit_group, 1, 2)
        backtest_condition_gird_box.addWidget(self.stop_loss_group, 2, 0)
        backtest_condition_gird_box.addWidget(self.max_drawdown_group, 2, 1)
        backtest_condition_gird_box.addWidget(self.limit_up_no_sell_group, 3, 0)
